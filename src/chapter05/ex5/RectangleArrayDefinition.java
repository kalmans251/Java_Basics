...
public class RectangleArrayDefinition {
	...
	public static void main(String[] args) {
		// 다차원 배열 ( 2차원 배열 )
		//   - 정방형 배열		: row(행) 에 대해서 열(colum, field) 이 동일한 배열.
		//   - 비정방형 배열	: row(행) 에 대해서 열 (colum, fild) 이 동일하지 않은 배열.
		...
		int [][] arr1 = new int[3][4];  //3 : 행의 갯수 ( 0, 1, 2 )
			...
			// 5. 정방형 배열 선언과 동시에 값 넣기 2   : 선언 , 값을 분리할수 있다.
			int[][] arr13 = { {100,110,120},{210,220,230} };
			
			int[][] arr14;
			//arr14 = { {100,110,120},{210,220,230} };  // 오류발생 [선언과 값을 분리해서 넣을 수 없다.]
			
			
			//10. 다양한 타입의 배열변수 선언하기
