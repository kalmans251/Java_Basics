...
class Student1{
	...
	//getter 와 setter를 통해 private인 field의 값을 변경,조회...{  shift + alt + s 누르고--> r    // Gene[r]ate getter and setter  }
	...
	//객체 자체를 프린트 할때 필드의 값 전체를 출력 할 수 있도록 , toString() : Object클래스에 위치하며 모든 클래스는 Object를 상속하여 Override 할 수 있다.
