package chapter04.ex7;

public class Break_Contril_Keyword {
	...
	public static void main(String[] args) {
		...
		//  case 2: 점프해서 한번에 외부의 for 문으로 탈출.( LABLE )
		
			pos1:for(int i = 0 ; i < 5 ; i++) {
				for(int j = 0 ; j < 5 ; j++) {
					if ( j == 2 ) {
						break pos1;			// 레이블 ( LAVBLE로 지정된 곳으로 점프해서 탈출 )
					}
			...
			System.out.println("===============================================");
		//  case 3: 점프해서 한번에 외부의 for 문으로 탈출.( 변수 값을 조정해서 탈출 )	
